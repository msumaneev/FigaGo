...
TRANSLATIONS = {
    ...
    "profile_type_electric": {"en":"Electric","tr":"Elektrikli","es":"Eléctrica","fr":"Électrique","de":"Elektrisch","uk":"Електричний","ar":"كهربائي","ka":"ელექტრო","ja":"電動","ko":"전동","zh-CN":"电动","zh-TW":"電動"},
    "profile_type_manual": {"en":"Manual","tr":"Manuel","es":"Manual","fr":"Manuel","de":"Manuell","uk":"Ручний","ar":"يدوي","ka":"მექანიკური","ja":"手動","ko":"수동","zh-CN":"手动","zh-TW":"手動"},
    ...
    "settings_auto_transport_desc": {"en":"Automatically pause battery tracking when speed exceeds the wheelchair's max limit.","tr":"Hız, tekerlekli sandalyenin maksimum hızını aştığında batarya hesaplamasını otomatik olarak duraklat.","es":"Pausar automáticamente el cálculo de la batería cuando la velocidad supere el límite máximo de la silla.","fr":"Mettre automatiquement en pause le calcul de la batterie lorsque la vitesse dépasse la limite du fauteuil.","de":"Akkuberechnung automatisch pausieren, wenn die Geschwindigkeit das Limit des Rollstuhls überschreitet.","uk":"Автоматично призупиняти розрахунок заряду батареї при перевищенні максимальної швидкості візка.","ar":"إيقاف حساب البطارية مؤقتاً تلقائياً عندما تتجاوز السرعة الحد الأقصى للكرسي المتحرك.","ka":"ავტომატურად შეაჩერე ბატარეის გაანგარიშება, როცა სიჩქარე ეტლის მაქსიმუმს გადააჭარბებს.","ja":"速度が車いすの上限を超えた場合、バッテリー計算を自動的に一時停止します。","ko":"속도가 휠체어 최대 속도를 초과하면 배터리 계산을 자동으로 일시 중지합니다.","zh-CN":"当速度超过轮椅的最高限速时，自动暂停电池计算。","zh-TW":"當速度超過輪椅的最高速限時，自動暫停電池計算。"},
